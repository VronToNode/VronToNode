...
pkgdatadir = $(datadir)/vrontonode
pkgincludedir = $(includedir)/vrontonode
pkglibdir = $(libdir)/vrontonode
pkglibexecdir = $(libexecdir)/vrontonode
...
CONFIG_HEADER = $(top_builddir)/src/config/vrontonode-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/vrontonode-config.h.in \
...
ACLOCAL = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/missing automake-1.15
AWK = mawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = vrontonode-cli
BITCOIN_DAEMON_NAME = vrontonoded
BITCOIN_GUI_NAME = vrontonode-qt
BITCOIN_TX_NAME = vrontonode-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = vrontonode
PACKAGE_BUGREPORT = www.vrontonode.org
PACKAGE_NAME = VronToNode Core
PACKAGE_STRING = VronToNode Core 1.3.0
PACKAGE_TARNAME = vrontonode
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /home/ubuntu/Desktop/VronToNode
abs_srcdir = /home/ubuntu/Desktop/VronToNode
abs_top_builddir = /home/ubuntu/Desktop/VronToNode
abs_top_srcdir = /home/ubuntu/Desktop/VronToNode
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/ubuntu/Desktop/VronToNode/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/vrontonode.icns
OSX_PLIST = $(top_srcdir)/share/qt/Info.plist #not installed
OSX_QT_TRANSLATIONS = da,de,es,hu,ru,uk,zh_CN,zh_TW
DIST_DOCS = $(wildcard doc/*.md) $(wildcard doc/release-notes/*.md)
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/vrontonode.ico \
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_vrontonode_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_vrontonode_coverage.info test_vrontonode.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/vrontonode.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/VronToNode-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/vrontonode-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/vrontonode-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/vrontonode-config.h
$(top_srcdir)/src/config/vrontonode-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/vrontonode-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/vrontonode.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/VronToNode-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VronToNode-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/VronToNode-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_vrontonode.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_vrontonode -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_vrontonode_filtered.info: test_vrontonode.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_vrontonode_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_vrontonode_coverage.info: baseline_filtered_combined.info test_vrontonode_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_vrontonode_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_vrontonode_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_vrontonode_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_vrontonode.coverage/.dirstamp:  test_vrontonode_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_vrontonode.coverage/.dirstamp total.coverage/.dirstamp
...
clean-local:
	rm -rf test_vrontonode.coverage/ total.coverage/ $(OSX_APP)
