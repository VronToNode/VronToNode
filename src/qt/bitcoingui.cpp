...
QFontDatabase::addApplicationFont(":/fonts/vrontonode_font");

QString windowTitle = tr("VronToNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VronToNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and VronToNode: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About VronToNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about VronToNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VronToNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VronToNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VronToNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a VronToNode: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the VronToNode Core help message to get a list with possible VronToNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("VronToNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VronToNode network", "", count));
}
...
{
    QString strTitle = tr("VronToNode Core"); // default title
