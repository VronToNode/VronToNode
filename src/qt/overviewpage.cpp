...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::VTN)
    {
    }
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& anonymizedBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->label_VronToNode4->setVisible(showImmature || showWatchOnlyImmature);
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    if (model && model->getOptionsModel()) {
        ...
        connect(ui->blabel_VronToNode, SIGNAL(clicked()), this, SLOT(openMyAddresses()));

    }

    // update the display unit, to not use the default ("VronToNode")
    updateDisplayUnit();
}
...
void OverviewPage::updateMasternodeInfo()
{
  ...
  if (chainActive.Height() >= 0 && chainActive.Height() < 3000) {
    ui->label_lcolat->setText("1,000 VTN");
    ui->label_mcolat->setText("3,000 VTN");
    ui->label_fcolat->setText("5,000 VTN");
  } else {
    ui->label_lcolat->setText("1,000 VTN");
    ui->label_mcolat->setText("3,000 VTN");
    ui->label_fcolat->setText("5,000 VTN");
...
double BlockRewardVronToNode =  static_cast<double>(BlockReward/COIN);
//int64_t VronToNodeSupply = chainActive.Tip()->nMoneySupply / COIN;
...
ui->label_CurrentBlockReward_value->setText(QString::number(BlockRewardVronToNode));
//ui->label_VronToNodeSupply_value->setText(QString::number(VronToNodeSupply));
