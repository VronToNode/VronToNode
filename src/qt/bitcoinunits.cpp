...
// Copyright (c) 2017-2018 The VTN Core developers
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case VTN:
            return QString("VTN");
        case mVTN:
            return QString("Milli-VTN (1 / 1" THIN_SP_UTF8 "000)");
        case uVTN:
            return QString("Micro-VTN (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case VTN:
            return QString("TestVTNs");
        case mVTN:
            return QString("Milli-TestVTNs (1 / 1" THIN_SP_UTF8 "000)");
        case uVTN:
            return QString("Micro-TestVTNs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
