...
/** Utility functions used by the VronToNode Qt UI.
 */
namespace GUIUtil
{
...
// Render VronToNode addresses in monospace font
...
// Parse "vrontonode:" URI into recipient object, return true on successful parsing
