...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("VronToNode Core"),
     ...
     * override -datadir in the vrontonode.conf file in the default data directory
     * (to be consistent with vrontonoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
