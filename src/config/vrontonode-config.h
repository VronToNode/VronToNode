/* src/config/vrontonode-config.h.  Generated from vrontonode-config.h.in by configure.  */
/* src/config/vrontonode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef VronToNode_CONFIG_H

#define VronToNode_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.vrontonode.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "VronToNode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "VronToNode Core 1.3.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "vrontonode"
