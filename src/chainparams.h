 ...
 * VronToNode system. There are three: the main network on which people trade goods
...
public:
    ...
    // const std::vector<unsigned char>& VronToNodeDevKey() const { return vVronToNodeDevKey; }
    // const std::vector<unsigned char>& VronToNodeFundKey() const { return vVronToNodeFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vVronToNodeDevKey;
    // std::vector<unsigned char> vVronToNodeFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
