...
public:
    ...
    {
        // vrontonode: the coin stake transaction is marked with the first output empty
    ...
    bool GetCoinAge(uint64_t& nCoinAge) const;  // vrontonode: get transaction coin age
};
