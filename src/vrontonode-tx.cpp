...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("VronToNode Core vrontonode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  vrontonode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded VronToNode transaction") + "\n" +
                               "  vrontonode-tx [options] -create [commands]   " + _("Create hex-encoded VronToNode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded VronToNode transaction
