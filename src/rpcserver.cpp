...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop VronToNode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "VronToNode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* VronToNode features */
        {"vrontonode", "masternode", &masternode, true, true, false},
        {"vrontonode", "listmasternodes", &listmasternodes, true, true, false},
        {"vrontonode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"vrontonode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"vrontonode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"vrontonode", "masternodedebug", &masternodedebug, true, true, false},
        {"vrontonode", "startmasternode", &startmasternode, true, true, false},
        {"vrontonode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"vrontonode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"vrontonode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"vrontonode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"vrontonode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"vrontonode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"vrontonode", "mnsync", &mnsync, true, true, false},
        {"vrontonode", "spork", &spork, true, true, false},
        {"vrontonode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"vrontonode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use vrontonoded, or the -server option to vrontonode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> vrontonode-cli " + methodname + " " + args + "\n";
}
