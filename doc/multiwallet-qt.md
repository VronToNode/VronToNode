...
In order to support loading of multiple wallets in vrontonode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is vrontonode.cpp.
...
Changes to vrontonode.cpp
----------------------
vrontonode.cpp is the entry point into vrontonode-qt, and as such, will require some minor modifications to provide hooks for
