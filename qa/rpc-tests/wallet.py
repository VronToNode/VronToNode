...
#   c) node1 mines 32 blocks, so now node 0 has 60001vrontonode, node 1 has 4250vrontonode, node2 has none.
#   d) node0 sends 601 vrontonode to node2, in two transactions (301 vrontonode, then 300 vrontonode).
