Contributing to VronToNode Core
============================

The VronToNode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the VronToNode Core project, and is not to be
confused with overall VronToNode Network Protocol consensus changes.

Whether a pull request is merged into VronToNode Core rests with the project merge
...
Patches that change VronToNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the VronToNode consensus, it must have been
...
The project leader is the release manager for each VronToNode Core release.
